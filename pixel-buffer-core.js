...
const get_instance = () => {
    ...
    Pixel_Buffer_Core.override = (name, obj) => {
        if (name === 'ta_math') {
            ta_math = obj;
            //{resize_ta_colorspace, copy_rect_to_same_size_8bipp, copy_rect_to_same_size_24bipp, dest_aligned_copy_rect_1to4bypp} = ta_math;
            resize_ta_colorspace = ta_math.resize_ta_colorspace;
            copy_rect_to_same_size_8bipp = ta_math.copy_rect_to_same_size_8bipp;
            copy_rect_to_same_size_24bipp = ta_math.copy_rect_to_same_size_24bipp;
            dest_aligned_copy_rect_1to4bypp = ta_math.dest_aligned_copy_rect_1to4bypp;
            
        }
    }

    Pixel_Buffer_Core.get_instance = get_instance;
